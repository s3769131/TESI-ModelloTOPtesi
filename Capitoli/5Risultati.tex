...
\begin{lstlisting}[float=t,title={Distribuzione dei pixel di training (TR) e test (TE) classe per classe.},
                   label=lst:esempio, frame=lines]
TR:					TE:
...
Su questo \emph{dataset} i risultati sono stati interessanti, poiché
